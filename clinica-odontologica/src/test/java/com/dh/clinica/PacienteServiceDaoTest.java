...
@SpringBootTest
public class PacienteServiceDaoTest {
//    private static PacienteServiceDao pacienteService = new PacienteServiceDao(new PacienteDaoH2(new DomicilioDaoH2()));
//    private DomicilioServiceDao domicilioServiceDao = new DomicilioServiceDao(new DomicilioDaoH2());
//
//    @BeforeClass
